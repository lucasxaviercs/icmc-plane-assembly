...
CallSai:	
	...
	; -----------------------------------------------------------------
	; Teste do SQR (Square) para gerar 'Q'
	; -----------------------------------------------------------------
	loadn r1, #4		; Carrega 4 no registrador r1
	sqr r1			; Executa SQR: r1 = 4 * 4 = 16
	loadn r2, #'A'		; Carrega 'A' (65) no registrador r2
	add r3, r1, r2		; Soma: r3 = 16 + 65 = 81 (ASCII de 'Q')
	loadn r0, #32		; Escolhe a linha 32 da tela
